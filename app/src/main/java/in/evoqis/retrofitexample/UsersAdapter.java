...
public class UsersAdapter extends RecyclerView.Adapter<UsersAdapter.UsersViewHolder> {
    ...
    public void onBindViewHolder(UsersViewHolder holder, final int position) {
        ...
        holder.status.setText("Status: " + userListResponseData.get(position).getStatus());
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(context, "Id:"+userListResponseData.get(position).getId()+"\nName:"+userListResponseData.get(position).getName(), Toast.LENGTH_SHORT).show();
            }
        });
    }
